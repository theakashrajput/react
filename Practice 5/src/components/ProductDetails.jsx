  ...
  return (
    <div className="flex items-center justify-center flex-col gap-10 w-full h-screen">
      <div className="w-[20%] h-[400px] bg-zinc-100 rounded-sm p-5 text-zinc-800">
        <div className="w-full h-40 bg-zinc-300 rounded-sm">{name} Img</div>
        <h1 className="bg-zinc-300 text-3xl mt-5 mb-3 font-medium">{name}</h1>
        <p className="h-20 bg-zinc-300">{name} Description</p>
